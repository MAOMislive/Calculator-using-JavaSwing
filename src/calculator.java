...
class calculator extends JFrame implements ActionListener {
    ...
    public static void main(String args[]) throws IOException {
        ...
        // clear button
        bcl = new JButton("C",new ImageIcon("src/resources/clear.png"));
        ...
        ba = new JButton("+",new ImageIcon("src/resources/add.png"));
        ...
        bs = new JButton("-",new ImageIcon("src/resources/sub.png"));
        ...
        bd = new JButton("/",new ImageIcon("src/resources/divide.png"));
        ...
        bm = new JButton("*",new ImageIcon("src/resources/multi.png"));
        ...
        BufferedImage myPicture = ImageIO.read(new File("src/resources/header.png"));
